package uk.margarine.gone_nuts.block;
...
import uk.margarine.gone_nuts.block.custom.PeanutCropBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> PEANUTS = registerBlock("peanuts",
            () -> new PeanutCropBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT)));
